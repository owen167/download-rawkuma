...
class KakaoDownloader:
    ...
    async def _ensure_browser(self) -> Page:
        ...
        await self._page.goto("https://webtoon.kakao.com/", wait_until="domcontentloaded", timeout=self._timeout_ms())
        return self._page
    ...
    async def _content(self, content_id: int) -> dict[str, Any]:
        payload = await self._api_json(f"/decorator/v1/decorator/contents/{content_id}")
